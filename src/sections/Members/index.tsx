...
import { UserPlus, ArrowLeft, Loader2, Eye, EyeOff, CheckCircle2 } from 'lucide-react';
      ...
      {saveState === 'success' && (
        <div className="card p-8 flex flex-col items-center text-center">
          ...
          <div className="flex gap-3">
            <Button variant="secondary" onClick={handleReset}>Add another</Button>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <section className="card p-6 space-y-5">
              ...
              <div>
                ...
                <Input id="member-name" placeholder="e.g. John Smith" value={fullName} onChange={(e) => setFullName(e.target.value)} disabled={saveState === 'saving'} />
              </div>
              <div>
                <Label htmlFor="member-email">Email Address <span className="text-red-400">*</span></Label>
                <Input id="member-email" type="email" placeholder="supplier@example.com" value={email} onChange={(e) => setEmail(e.target.value)} disabled={saveState === 'saving'} />
              </div>
              <div>
            ...
            <section className="card p-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="badge bg-amber-500/10 text-amber-400 border border-amber-500/20">Supplier</span>
              </div>
            </section>
