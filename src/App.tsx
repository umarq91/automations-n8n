            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2.5">
                ...
                {organizations.length > 0 && (
                  <div className="relative">
                    ...
                    >
                      ...
                      <span className="max-w-[110px] truncate font-medium">{activeOrg?.name ?? 'No org'}</span>
                ...
                <div className="hidden md:block relative w-[220px]">
                  <Search size={13} className="absolute left-3 top-1/2 -translate-y-1/2 text-ds-muted" />
                  <input
                ...
                {/* Notifications */}
                <button
                  className="p-2 rounded-xl bg-ds-surface border border-ds-border hover:bg-ds-hover transition"
                  title="Notifications"
                >
                  <Bell size={15} className="text-ds-text2" />
                </button>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <LogOut size={14} className="text-ds-muted group-hover:text-red-400 transition-colors" />
                  </button>
                </div>
              </div>
            </div>
